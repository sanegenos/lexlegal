...
const testimonials = [
  {
    ...
    content: "I worked with Lexlegal for the skilled worker visa. They have worked very meticulously from the beginning of the process and provided accurate guidance. Every time I wrote to them, I received an instant reply and they were always accessible. I would like to thank the whole Lexlegal team, especially Kerim. It was a good chance to meet you. I would recommend Lexlegal to everyone with peace of mind.",
  ...
  {
    title: "---",
    content: "team, especially Kerim. It was a good chance to meet you. I would recommend Lexlegal to everyone with peace of mind.",
    logo: "img/black-google-plus.png"
  },
  {
    ...
    <section id="testimonial-section" className="bg-gray-100 py-10 m-2 p-2">
      <div className="max-w-7xl mx-auto overflow-hidden relative">
        <div className="w-full text-left mb-8">
          <h5 className="text-lg font-semibold uppercase">Yorumlar</h5>
        </div>

        <div className="flex flex-col md:flex-row">

          <div className="widelogo flex flex-col justify-around items-center space-y-4 mb-8 md:mb-0">
            <Image src="img/t-pilot.jpg" alt="Pilot testimonial" width={200} height={100} />
            <Image src="img/black-google-plus.png" alt="Google Plus testimonial" width={200} height={100} />
          </div>
                  ...
                  <blockquote className="text-center">
                    ...
                    <footer className="mt-4 text-blue-600">
                      <a href="#" className="w-full flex justify-center items-center">
                        <Image src={testimonial.logo} alt="Logo" width={100} height={100} className="mr-2" />
                        &rarr;
                      </a>
                    </footer>
                  </blockquote>

    ...
    return (
        <section id="banner" className="bg-cover bg-center bg-white bg-no-repeat py-16 relative min-h-96"
            ...
            <div className="max-w-lg z-30 mb-8 md:mb-0">
                ...
                <a href="https://web.whatsapp.com/send?phone=447739699968&text=" target="_blank" className="inline-block bg-green-500 py-3 px-6 rounded-md hover:bg-green-400 transition text-white">
                Whatsapp
                </a>
            </div>

            <div className="mx-auto text-white text-center bg-gray-600 bg-opacity-10 rounded-lg p-6 shadow-lg z-20 w-full md:w-auto">
                <h2 className="text-2xl md:text-3xl text-left font-bold mb-4">Ücretsiz ön görüşme için ekibimiz en kısa sürede size dönüş yapacaktır</h2>
                ...
                <form action="https://submit-form.com/T6Pj3IKoD">
                    ...
                    <button type="submit" target="_blank" className="w-full self-center bg-white text-black font-semibold py-2 rounded hover:bg-gray-300 transition duration-300 uppercase">
                        Gönder
                    </button>
                </form>
            </div>

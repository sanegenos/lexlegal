...
export default function Banner() {
    return (
        <section className="flex flex-col md:flex-row justify-between items-center bg-cover bg-center bg-no-repeat relative min-h-screen" style={{backgroundImage: "url('/img/banner.jpg')"}}>
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="md:w-1/2 mb-8 md:mb-0">
                    <h2 className="text-sm text-purple-700 font-semibold mb-2">WE ARE</h2>

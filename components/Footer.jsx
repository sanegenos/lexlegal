    ...
    <footer id="footer" className="bg-gray-900 text-white py-10 flex flex-col">
      ...
      <div className="container mx-auto flex flex-col md:flex-row md:justify-between md:items-center max-w-7xl border-b border-gray-700 pb-10">
        <div className="mb-8 md:mb-0 text-center md:text-left">
          <div className="flex flex-col md:flex-row md:items-start mb-4 space-y-4 md:space-y-0 md:space-x-6">
            <div className='w-48'>
              <span className="text-2xl font-bold">Lex Legal</span>
            </div>
            <div className="flex space-x-4">
              ...
              <div className='w-48 text-left'>
                <span className="text-sm text-left font-bold">Office of the Immigration<br />
            ...
            <div className="flex space-x-4">
              ...
              <div className='w-48 text-left'>
                <span className="text-sm text-left font-bold">Information Commissioner’s Office<br/> 
                  Reference Number:<br/> 
                  ZB295269
                </span>
              </div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between max-w-7xl p-10">
        ...
        <div className="mb-8 md:mb-0 text-left">
          <a href="https://maps.app.goo.gl/k4jSaiAuCUpUqcaz6" target="_blank" className="text-sm">Lex Legal <br/>
            Meridien House <br/>
        ...
        <div className="text-center md:text-right">
          <p className="text-sm"><a href="mailto:info@lexlegal.com" className="hover:text-gray-400">contact@lexlegal.com</a></p>
          <p className="text-sm"><a href="tel:+447739699968" className="hover:text-gray-400">+44 77 3969 9968</a></p>
          <p className="text-sm"><a href="tel:+442039880575" className="hover:text-gray-400">+44 20 3988 0575</a></p> 
        </div>
      </div>

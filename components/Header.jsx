...
export default function Header() {
    return (
        <header id="header" className="bg-white py-4 flex flex-col justify-center items-center w-full border-b relative z-20">
            ...
            <div>
                <a href="tel:+447739699968" className="text-blue-700 hover:text-blue-900 pb-3 border-b border-blue-700 hover:border-blue-900 uppercase">Bizimle hemen iletişime geçin.</a>
            </div>
            </div>
